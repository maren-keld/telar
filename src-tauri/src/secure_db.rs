...
fn read_migrations() -> Vec<(&'static str, &'static str)> {
    ...
    vec![
        ...
        ("013_session_done.sql", include_str!("../migrations/013_session_done.sql")),
        ("014_space_check_notes.sql", include_str!("../migrations/014_space_check_notes.sql")),
        ("015_space_check_present.sql", include_str!("../migrations/015_space_check_present.sql")),
    ]
}
