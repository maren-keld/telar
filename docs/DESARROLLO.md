# Guía de desarrollo — Psicoterapia Lab
...
1. `./scripts/dev.sh` o tarea **Psicoterapia Lab: Dev** (⌘⇧B / F5)
...
Copia canónica: **`dist/Psicoterapia Lab.app`**. No uses `src-tauri/target/.../Psicoterapia Lab.app`.
...
- DB cifrada: `psicoterapia.enc.db` en Application Support (`cl.psicoterapialab.desktop`)
