...
export const EXTRA_HANDOUT_DEFS = {
  ...
  tcc_exposicion: {
    ...
    hierarchy: {
      ...
      steps: [
        { situation: 's1', suds: 'suds1', label: 'Más fácil' },
        { situation: 's2', suds: 'suds2', label: '' },
        { situation: 's3', suds: 'suds3', label: '' },
        { situation: 's4', suds: 'suds4', label: '' },
        { situation: 's5', suds: 'suds5', label: '' },
        { situation: 's6', suds: 'suds6', label: 'Más temida' },
      ],
    },
    activityGroups: [
      {
        title: 'Cómo llenar la escalera',
        items: [
          'Cada peldaño = una situación concreta (dónde, con quién, cuánto tiempo) + un número SUDS.',
    ...
    sections: [
      ...
      { key: 's1', title: '1. Más fácil — situación', rows: 2 },
      { key: 'suds1', title: '1. SUDS (0–100)', type: 'number', min: 0, max: 100 },
      { key: 's2', title: '2. Situación', rows: 2 },
      { key: 'suds2', title: '2. SUDS (0–100)', type: 'number', min: 0, max: 100 },
      { key: 's3', title: '3. Situación', rows: 2 },
      { key: 'suds3', title: '3. SUDS (0–100)', type: 'number', min: 0, max: 100 },
      { key: 's4', title: '4. Situación', rows: 2 },
      { key: 'suds4', title: '4. SUDS (0–100)', type: 'number', min: 0, max: 100 },
      { key: 's5', title: '5. Situación', rows: 2 },
      { key: 'suds5', title: '5. SUDS (0–100)', type: 'number', min: 0, max: 100 },
      { key: 's6', title: '6. Más temida — situación', rows: 2 },
      { key: 'suds6', title: '6. SUDS (0–100)', type: 'number', min: 0, max: 100 },
      {
        key: 'primer_paso',
        title: 'Primera exposición acordada',
        hint: 'Qué, cuándo, cuánto dura, qué cuenta como completar, qué no se permite (p. ej. escapar a los 30 segundos).',
