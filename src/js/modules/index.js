...
const LEGACY_RENDERERS = {
  ...
  sig_linea_vida: renderTccGeneric,
  sig_carta_problema: renderTccGeneric,
  sig_condiciones_valia: renderTccGeneric,
  sig_felt_sense: renderTccGeneric,
  sig_pregunta_milagro: renderTccGeneric,
  dass21: renderDass21,
  eed: renderEed,
  qols: renderQols,
