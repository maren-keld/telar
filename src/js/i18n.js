...
const STRINGS = {
  es: {
    ...
    'settings.country': 'País de atención',
    'settings.countrySub': 'Previsión, documento de identidad y ciudad del registro',
    'settings.chooseCountry': '¿En qué país atiendes?',
    ...
    'module.asrs.label': 'ASRS v1.1',
    'asrs.title': 'ASRS v1.1',
    ...
    'notes.filter.answers': 'Respuestas',
    'notes.filter.notes': 'Notas',
    'notes.filter.highlights': 'Resaltado',
    'notes.filter.pinned': 'Fijado',
    'notes.filterAria': 'Filtrar contenido del panel derecho',
    'notes.add': '+ Nota',
    'notes.addTitle': 'Añadir nota clínica',
    'notes.assistant': 'Asistente IA',
    'notes.ask': 'Pregunta a la IA sobre el caso',
    'notes.askTitle': 'Consulta a la IA sobre el caso',
    'notes.send': 'Enviar',
    'notes.stop': 'Detener',
    'notes.thinking': 'Pensando...',
    'notes.more': 'Ver más',
    'notes.older': 'Ver {count} anteriores',
    'notes.noVisibleAnswer': 'No llegó una respuesta visible. Inténtalo de nuevo; si vuelve a pasar, revisa Ajustes → Asistente IA.',
    'notes.commentQuote': 'Tu comentario sobre la cita…',
    'notes.comment': 'Escribe un comentario…',
    'notes.aiReply': 'Respuesta IA',
    'notes.noteAuthor': 'Autor/a de la nota',
    'notes.copy': 'Copiar respuesta',
    'notes.star': 'Destacar nota',
    'notes.color': 'Cambiar color de la nota',
    'notes.delete': 'Eliminar nota',
    'ai.quick.analysis': 'Análisis del caso',
    'ai.quick.analysisHint': 'Revisa el tratamiento completo: orientación clínica, hipótesis, focos y cómo va el proceso.',
    'ai.quick.treatment': 'Generar tratamiento',
    'ai.quick.treatmentHint': 'Propone un plan por sesiones con módulos de Telar, sin repetir handouts.',
    'ai.quick.email': 'Generar emails',
    ...
    'tools.sessions': 'Sesiones',
    'tools.dark': 'Modo oscuro',
  ...
  en: {
    ...
    'settings.country': 'Practice country',
    'settings.countrySub': 'Coverage, ID number and city in the intake form',
    'settings.chooseCountry': 'Which country do you practice in?',
    ...
    'cssrs.title': 'C-SSRS',
    'cssrs.instruction': 'Always ask 1 and 2 (past month). If YES to 2, ask 3–5; if NO, go to 6. Item 6 covers lifetime and the past 3 months.',
    'cssrs.item': 'Item',
    'cssrs.item6': 'Item 6 · always ask',
    'cssrs.window.month': 'Past month',
    'cssrs.window.lifetime': 'Lifetime',
    'cssrs.window.recent': 'Past 3 months',
    'cssrs.risk.high': 'High risk',
    'cssrs.risk.moderate': 'Moderate risk',
    'cssrs.risk.low': 'Low risk',
    'cssrs.risk.none': 'No positive indicators',
    'cssrs.note': '© 2008 The Research Foundation for Mental Hygiene, Inc. Free clinical use authorized by The Columbia Lighthouse Project. This does not replace clinical evaluation; activate the safety protocol if risk is high.',
    'module.gad7.label': 'GAD-7',
    'gad7.title': 'GAD-7',
    ...
    'notes.filterAria': 'Filter right sidebar content',
    'notes.add': '+ Note',
    'notes.addTitle': 'Add clinical note',
    'notes.assistant': 'AI assistant',
    'notes.ask': 'Ask AI about the case',
    'notes.askTitle': 'Ask AI about the case',
    'notes.send': 'Send',
    'notes.stop': 'Stop',
    'notes.thinking': 'Thinking...',
    'notes.more': 'Show more',
    'notes.older': 'Show {count} earlier',
    'notes.noVisibleAnswer': 'No readable answer came back. Try again; if it happens again, check Settings → AI assistant.',
    'notes.commentQuote': 'Your comment on the quote…',
    'notes.comment': 'Write a comment…',
    'notes.aiReply': 'AI reply',
    'notes.noteAuthor': 'Note author',
    'notes.copy': 'Copy answer',
    'notes.star': 'Pin note',
    'notes.color': 'Change note color',
    'notes.delete': 'Delete note',
    'ai.quick.analysis': 'Case analysis',
    'ai.quick.analysisHint': 'Review the full treatment: clinical approach, hypotheses, focus areas and progress.',
    'ai.quick.treatment': 'Create treatment plan',
    'ai.quick.treatmentHint': 'Suggest a session-by-session plan using Telar modules, without repeating handouts.',
    'ai.quick.email': 'Draft email',
